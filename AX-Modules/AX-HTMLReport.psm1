...
function Get-MhtClose
{
$Footer = "Report v{3} run {0} by {1}\{2}" -f $(Get-Date),$env:UserDomain,$env:UserName,'4.0'
$Report = @"
<div class="section">
    <hr />
...
Param(
    ...
    [validateset(20,25,40,50,60,75,80,100)][int]$SectionSize
)
